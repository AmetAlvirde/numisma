...
appears twice in `vitest.config.ts` (the exclusion comment and the `exclude`
entry it explains), in the `pnpm plans` script, in `apps/tui/README.md`, in the
