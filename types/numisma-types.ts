/**
 * numisma-types.ts - Comprehensive domain model for the Numisma financial platform
 *
...
// Don't know how (or why) to do this yet.
// // Export all types as part of the Numisma namespace
// export namespace Numisma {
//   // Core domain types
//   export type Position = Position;
//   export type Portfolio = Portfolio;
//   export type Asset = Asset;
//   export type Order = Order;
//   export type StopLossOrder = StopLossOrder;
//   export type TakeProfitOrder = TakeProfitOrder;
//   export type PositionDetails = PositionDetails;
//   export type Thesis = Thesis;
//   export type JournalEntry = JournalEntry;

//   // Valuations and reporting
//   export type PortfolioValuation = PortfolioValuation;
//   export type PositionValuation = PositionValuation;
//   export type PerformanceReport = PerformanceReport;
...
//   // Analytics
//   export type TradingMetrics = TradingMetrics;
//   export type TradingInsight = TradingInsight;
//   export type MarketData = MarketData;

//   // Notifications and alerts
//   export type Notification = Notification;
//   export type PriceAlert = PriceAlert;

//   // Integrations
//   export type ExchangeAccount = ExchangeAccount;
//   export type Wallet = Wallet;

//   // Primitive types
//   export type DateOrGenesis = DateOrGenesis;
//   export type WalletType = WalletType;
//   export type PositionStatus = PositionStatus;
//   export type OrderStatus = OrderStatus;
//   export type OrderType = OrderType;
//   export type SizeUnit = SizeUnit;
//   export type TradeSide = TradeSide;
//   export type TimeFrame = TimeFrame;
//   export type MetricType = MetricType;
//   export type AssetLocationType = AssetLocationType;
//   export type TimeFrameUnit = TimeFrameUnit;
//   export type TimeFrameGranularity = TimeFrameGranularity;
//   export type AggregationMethod = AggregationMethod;
//   export type ReportType = ReportType;
//   export type NotificationType = NotificationType;
//   export type NotificationPriority = NotificationPriority;
// }
