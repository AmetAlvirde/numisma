    ...
    return (
      <div className="w-full max-w-3xl mx-auto space-y-6 p-4 font-mono bg-background text-text-primary">
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Badge
                    variant="outline"
                    className="bg-opacity-20 border-opacity-50 bg-gold-primary border-gold-primary text-gold-primary"
                  >
                    24h Change
                  </Badge>
              ...
              <div className="flex gap-2">
                <Badge
                  variant="outline"
                  className="bg-interactive bg-opacity-20 border-blue-primary border-opacity-50 text-blue-light"
                >
                ...
                <Badge
                  variant="outline"
                  className="bg-interactive bg-opacity-20 border-gold-primary border-opacity-50 text-blue-light"
                >
                ...
                <Badge
                  variant="outline"
                  className="bg-interactive bg-opacity-20 border-success border-opacity-50 text-blue-light"
                >
          ...
          <CardHeader className="pb-3 border-b border-divider">
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg flex items-center gap-2 text-gold-primary">
                <Clock className="h-5 w-5 text-gold-primary opacity-70" />
                Overnight Activity
              </CardTitle>
            </div>
          </CardHeader>
          <CardContent className="space-y-4 p-4">
            <div className="rounded-lg p-3 flex items-start justify-between border border-success border-opacity-20 border-l-4 border-l-success bg-success bg-opacity-10">
            ...
            <div className="rounded-lg p-3 flex items-start justify-between border border-warning border-opacity-20 border-l-4 border-l-warning bg-warning bg-opacity-10">
              <div className="flex gap-3">
            ...
            <Button
              variant="ghost"
              className="w-full justify-center text-gold-primary hover:bg-gold-primary hover:bg-opacity-10 transition-colors"
            >
              View all activity
        ...
        <Card className="shadow-lg border border-divider bg-card">
          ...
          <CardContent className="space-y-4 p-4">
            <div className="rounded-lg p-4 flex items-start justify-between border border-divider border-l-4 border-l-warning bg-card bg-opacity-70">
              <div>
                <div className="flex items-center gap-2">
                  <div className="font-mono text-xs px-1.5 py-0.5 rounded bg-warning bg-opacity-20 text-warning">
                    BTC
                  </div>
                  <div className="font-medium text-text-primary">Bitcoin</div>
                  <Badge
                    variant="outline"
                    className="ml-1 text-xs bg-interactive bg-opacity-20 border-gold-primary border-opacity-50 text-blue-light"
                  >
                    FUTURES
                  </Badge>
                </div>
            ...
            <div className="rounded-lg p-4 flex items-start justify-between border border-divider border-l-4 border-l-blue-primary bg-card bg-opacity-70">
              <div>
                <div className="flex items-center gap-2">
                  <div className="font-mono text-xs px-1.5 py-0.5 rounded bg-blue-primary bg-opacity-20 text-blue-primary">
                    ETH
                  </div>
                  <div className="font-medium text-text-primary">Ethereum</div>
                  <Badge
                    variant="outline"
                    className="ml-1 text-xs bg-interactive bg-opacity-20 border-blue-primary border-opacity-50 text-blue-light"
                  >
                    SPOT
                  </Badge>
                </div>
            ...
            <div className="rounded-lg p-4 flex items-start justify-between border border-divider border-l-4 border-l-purple-500 bg-card bg-opacity-70">
              <div>
                <div className="flex items-center gap-2">
                  <div className="font-mono text-xs px-1.5 py-0.5 rounded bg-purple-500 bg-opacity-20 text-purple-300">
                    SOL
                  </div>
        ...
        <Card className="shadow-lg border border-divider bg-card">
          <CardHeader className="pb-3 border-b border-divider">
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg flex items-center gap-2 text-gold-primary">
                <DollarSign className="h-5 w-5 text-gold-primary opacity-70" />
                Exchange Overview
              </CardTitle>
            </div>
          </CardHeader>
          <CardContent className="p-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="rounded-lg p-4 bg-card bg-opacity-70 border border-divider">
              ...
              <div className="rounded-lg p-4 bg-card bg-opacity-70 border border-divider">
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <Badge
                    variant="secondary"
                    className="bg-interactive text-blue-light bg-opacity-80 text-text-tertiary border-text-tertiary border-opacity-30"
                  >
        ...
        <Card className="shadow-lg border border-divider bg-card">
          <CardHeader className="pb-3 border-b border-divider">
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg flex items-center gap-2 text-gold-primary">
                <BarChart3 className="h-5 w-5 text-gold-primary opacity-70" />
                Position Breakdown
              </CardTitle>
            </div>
          </CardHeader>
          <CardContent className="p-4">
            <Tabs defaultValue="all" className="w-full">
              ...
              <TabsContent value="all" className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-lg p-4 text-center border border-blue-primary border-opacity-30 border-l-4 border-l-blue-primary bg-blue-primary bg-opacity-10">
                  ...
                  <div className="rounded-lg p-4 text-center border border-gold-primary border-opacity-30 border-l-4 border-l-gold-primary bg-gold-primary bg-opacity-10">
